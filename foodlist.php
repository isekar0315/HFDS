				...
				<div class="col-md-3">
					<form method="post" action="cart.php?action=add&id=<?php echo $item["id"]; ?>">
						<div class="mypanel" align="center";>
							...
							<div class="row">
								<div class="col-xs-2"><h5 class="text-info"></h5></div>
								<div class="col-xs-3"><h5 class="text-info">Quantity:<br> <input type="number" min="1" max="25" name="quantity" class="form-control" value="1" style="width: 60px;"> </h5>
								</div>
								<div class="col-xs-6">
								<input type="submit" name="add" style="margin-top:25px;" class="btn  btn-warning" value="Add to Cart">
								</div>
							</div>
